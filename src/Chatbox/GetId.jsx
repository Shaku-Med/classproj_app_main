const getCanvasFingerprint = () => {
    ...
    ctx.font = '14px Arial';
    ctx.fillStyle = '#f60';
    ctx.fillRect(125, 1, 602, 20);
    ctx.fillStyle = '#069';
    ctx.fillText('Something to put here. Looks Fine for everyone!', 20, 105);
    ctx.fillStyle = 'rgba(102, 204, 0, 0.7)';
    ctx.fillText('Something to put here. Looks Fine for everyone!', 4, 17);
            ...
            dbRequest.onsuccess = event => {
                ...
                if (isDelete) {
                    ...
                    getRequest.onsuccess = () => {
                        ...
                        if ((!uniqueId && !isadd) || shouldadd || !hasData) {
